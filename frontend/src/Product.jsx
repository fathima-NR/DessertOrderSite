    ...
    <>
      ...
      <div>
        <div style={{ backgroundColor: '#fff0f7' }}>
          ...
          <p id='p1'> At yummy, we offer a wide range of products, both sweet & savoury. Our offerings include <br /> indulgent brownies, cakes & desserts, artisanal breads, puffs & quiches, wholesome sandwiches,<br /> wraps & rolls, beverages and more.</p>
        </div>
<div>
<h2 className=' fw-bold  mt-5 text-center ms-4 ' style={{color:'#6C0345'}}>Cake By Occasion </h2>
</div>
        ...
        {Data && Data.length > 0 ? (
          ...
          <ul >
            ...
            {Data.map((item) => (
              ...
              <li key={item.id} className="col-xl-2 col-lg-4 col-md-4 col-sm-4 mb-4 ">
